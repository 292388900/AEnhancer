...
public class AggrSignatureParser {
     ...
     */
    public static AggrSignatureInfo parseSignature(ProceedingJoinPoint jp) throws CodingError {
            ...
            for (Class<?> paramType : paramTypes) {
                if (Aggregation.isAggregationType(paramType)) {
                    ...
                    if (++aggregation > 1) {
                        ...
                        throw new CodingError("at most one Aggregation is allowed in param");
                    }
